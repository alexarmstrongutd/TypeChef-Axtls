...
extern int ssl_write(SSL *ssl, const unsigned char out_data[], int out_len);
...
extern int ssl_obj_memory_load(SSL_CTX *ssl_ctx, int obj_type, const unsigned char data[], int len, const char *password);
